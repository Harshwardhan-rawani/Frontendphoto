         ...
         <div className='xl:px-5 xl:py-7 xl:grid xl:grid-cols-6 xl:gap-20 xl:w-[95%] h-fit'>
            <div className='xl:col-span-2 flex space-x-3 xl:space-x-5'>
              <Link to={"/uploads"} className='hover:text-black rounded-full xl:w-14 xl:h-14 w-10 h-10 border-2 border-gray-600 flex justify-center items-center'>
                <div  className=' xl:text-2xl md:text-xl text-lg text-gray-500'>{user ?<img src={`http://localhost:8000/${image}`} className='w-fit h-fit rounded-full' />:<FaRegUser/>}</div>
              </Link>
              <div>
           ...
           <div className='h-10 flex justify-center xl:col-span-3 group xl:mt-0 mt-2'>
            ...
            <div className='outline-none h-full px-2 rounded-r-md  bg-[#e8e6e6] text-gray-400 group-hover:ring-1 group-hover:ring-gray-300'><FaRegUser/></div>
           </div>
