...
function Photo() {
  ...
  return (
   ...
   <div className='px-3 text-xl font-semibold mt-3'>Photo</div>
   <div className='px-3 py-2' >
     ...
     <div className='h-20'></div>
       <Link to={"/uploadphoto"} className='border-2 bg-[#fff] hover:border-slate-500 w-12  h-12 xl:w-14 xl:h-14 rounded-full fixed xl:bottom-3 bottom-20 right-3 flex justify-center items-center'> <FiPlus  className='text-3xl xl:text-4xl hover:text-black'/></Link>
   </div>
   </>
  )
}
